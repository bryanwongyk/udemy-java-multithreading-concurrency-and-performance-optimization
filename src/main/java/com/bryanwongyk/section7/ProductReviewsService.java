package com.bryanwongyk.section7;
...
public class ProductReviewsService {
    ...
    // this could technically be a normal ReentrantLock since we can only add/remove product (and no reads)
    // for sake of exercise we will use ReentrantReadWriteLock
    ReentrantReadWriteLock rwProductLock = new ReentrantReadWriteLock();
    ReentrantReadWriteLock rwReviewsLock = new ReentrantReadWriteLock();  // can add/remove/get reviews
    ...
    Lock getLockForAddProduct() {
        // Add code here
        return this.rwProductLock.writeLock();
    }
    ...
    Lock getLockForAddProductReview() {
        // add code here
        return this.rwReviewsLock.writeLock();
    }

    Lock getLockForGetAllProductReviews() {
        // add code here
        return this.rwReviewsLock.readLock();
    }
